...
const ChatInterface = () => {
  const [messages, setMessages] = useState([
    {
      type: 'assistant',
      content: "Hi, I'm M's Chatbot Agent! Welcome to the portfolio website. I'm here to guide you through Srinija's projects, skills, and accomplishments. Feel free to ask me about her work, expertise, or anything else you'd like to explore. Let's get started!"
    }
  ]);
